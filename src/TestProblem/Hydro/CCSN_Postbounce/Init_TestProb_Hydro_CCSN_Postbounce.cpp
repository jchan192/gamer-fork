...
static int     NUC_Mode;                        // Mode for internal energy in SetGridIC()
                                                // (0=Pres Mode, 1=Temp Mode)
// =======================================================================================
...
// ********************************************************************************************************************************
   ...
   ReadPara->Add( "NUC_Mode",            &NUC_Mode,              0,             0,                1                 );
#  ifdef MHD
...
#     endif
      ...
      Eint = EoS_DensPres2Eint_CPUPtr( Dens, Pres, Passive, EoS_AuxArray_Flt, EoS_AuxArray_Int,
                                       h_EoS_Table, NULL );
...
//-------------------------------------------------------------------------------------------------------
// Function    :  Record_CentralDens_CCSN_PostBounce
// Description :  Record the maximum density around the box center
//-------------------------------------------------------------------------------------------------------
void Record_CentralDens_CCSN_PostBounce()
{
...
// Load IC Table
   if ( OPT__INIT != INIT_BY_RESTART )   LoadICTable_CCSN_PostBounce();
...
#  endif
   ...
   Aux_Record_User_Ptr            = Record_CCSN_PostBounce;
