...
//       b. use the SOR scheme to evaluate potential (store in Pot_Array_InF[])
// ------------------------------------------------------------------------------------------------------------
...
//          odd-even ordering
            for (int pass=0; pass<2; pass++)
            {
               ...
               for (int k=1+POT_USELESS; k<POT_NXTF-1-POT_USELESS; k++)
               {
                  i_start = i_start_k;
                  kp      = k+1;
                  km      = k-1;
                  ...
                  for (int j=1+POT_USELESS; j<POT_NXTF-1-POT_USELESS; j++)
                  {
                     jp = j+1;
                     jm = j-1;
                     jj = j-1-POT_USELESS;

                     for (int i=i_start; i<POT_NXTF-1-POT_USELESS; i+=2)
                     {
                        ip = i+1;
                        im = i-1;
                        ii = i-1-POT_USELESS;
...
//       c. copy data : Pot_Array_InF --> Pot_Array_Out
// ------------------------------------------------------------------------------------------------------------
